...
from .priorities import ROTATION_ORDER  # topic rotation order
...
def make_interleaved(theory_today: str, day_index: int, rotation: List[str]) -> str:
    """Select MCQ topic different from today's theory topic."""
...
def build_schedule(
    ...
    """Generate a comprehensive NEET SS full study plan (hours-based)."""
    ...
    for i, d in enumerate(days):
        ...
        day_plan: Dict[str, Any] = {
            ...
            "theory": {"topic": theory_topic, "hours": theory_hr},
            "mcq": {
                "topic": mcq_topic,
                "hours": mcq_hr,
